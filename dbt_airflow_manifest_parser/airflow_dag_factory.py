...
class AirflowDagFactory:
    ...
    def __init__(self, config_path, env: str,
                 dbt_config_file_name: str = 'dbt.yml',
                 k8s_config_file_name: str = 'k8s.yml',
                 airflow_config_file_name: str = 'airflow.yml'):
        self._builder = DbtAirflowTasksBuilderFactory(config_path, env, dbt_config_file_name, k8s_config_file_name)\
            .create()
    ...
    def create(self) -> DAG:
        ...
        with DAG(
            ...
            tasks = self._builder.parse_manifest_into_tasks(self._manifest_file_path(config))
