...
from dbt_airflow_factory.tasks_builder.graph import is_gateway_valid_dependency, GatewayConfiguration

presentation_schema_name = "presentation"
staging_schema_name = "stg"
gateway_config = GatewayConfiguration(
    separation_schemas=[staging_schema_name, presentation_schema_name],
